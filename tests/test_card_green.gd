...
func run(t: Object) -> void:
	...
	hf2.abilities.run(TriggerV2.Type.ON_ABILITY_HIT, AbilityContextV2.new(c2, hf2, lb2, 0, {}))
	...
	hf3.abilities.run(TriggerV2.Type.ON_ABILITY_HIT, AbilityContextV2.new(c3, hf3, other3, 0, {}))
	...
	apt5.abilities.run(TriggerV2.Type.ON_REFRESH, AbilityContextV2.new(c5, apt5, null, 0, {}))
	...
	t.ok(not CombatV2.attack(c6, apt6), "APTG 攻擊回傳 False")
	...
	sp7.abilities.run(TriggerV2.Type.ON_DEPLOY, AbilityContextV2.new(c7, sp7, null, 0, {}))
	...
	sp8.abilities.run(TriggerV2.Type.ON_DEPLOY, AbilityContextV2.new(c8, sp8, null, 0, {}))
	...
	GreenCardsV2.lucky_effects(c9, p9)
	...
	GreenCardsV2.lucky_effects(c10, p10)
	...
	GreenCardsV2.lucky_effects(c11, p11, false, true, false)
	...
	GreenCardsV2.lucky_effects(c12, p12, false, false, true)
	...
	GreenCardsV2.lucky_effects(c13, p13, true, false, false)
	...
	CombatV2.attack(c14, killer14)   # ADCW large_cross 命中並斬殺 (1,0) 的 LUCKYBLOCK
